table 50104 "IUSUP Course Journal Line"
{
    ...
    // procedure SetUpNewLine(LastResJnlLine: Record "IUSUP Course Journal Line")
    // var
    ...
    begin
        ...
        "Course Edition" := SalesLine."IUSUP Course Edition";
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyCourseJournalLineFromSalesHeader(var SalesHeader: Record "Sales Header"; var CourseJournalLine: Record "IUSUP Course Journal Line")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCopyCourseJournalLineFromSalesLine(var SalesLine: Record "Sales Line"; var CourseJournalLine: Record "IUSUP Course Journal Line")
    begin
    end;
